...
export default function Homepage() {
  return (
    ...
    >
      <Link href="findBooks" role="linkToBookSearch" className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start text-4xl font-bold my-6 text-blue-300 hover:text-gray-400
">
